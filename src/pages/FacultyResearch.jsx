...
const FacultyResearch = () => {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("facultyResearch");
  ...
  const handleSave = () => {
    localStorage.setItem("facultyResearch", JSON.stringify(formData));
    alert("Faculty Research details saved successfully!");
  };
          ...
          <Card.Body className="p-4 p-md-5">
            ...
            <Form>
              <Row className="gy-3">
                ...
                {/* Is Collaborative / Collaborator */}
                <Col xs={12} md={6}>
                  <Form.Group controlId="formCollaborative">
                    <Form.Label className="fw-semibold">
                      Is Collaborative
                    </Form.Label>
                    <Form.Select
